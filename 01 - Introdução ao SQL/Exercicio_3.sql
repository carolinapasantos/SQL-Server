...
-- Exercícios A, os primeiros 100 clientes da história com um vale compras de R$ 10.000. --
SELECT 
	TOP(100) *
FROM
	DimCustomer
...
-- Exercícios B, os primeiros 20% de clientes da história com um vale compras de R$ 2.000. --
SELECT
	TOP(20) PERCENT *
FROM
	DimCustomer
...
-- Exercícios C e D, retornar apenas as 100 primeiras linhas, mas apenas as colunas FirstName, EmailAddress, BirthDate. Renomeie as colunas anteriores para nomes em português. --
SELECT
